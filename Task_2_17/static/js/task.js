...
function renderChart() {
    ...
    var city = pageState["nowSelectCity"];//城市
    var gradTime = pageState["nowGraTime"];//日期
    ...
    for (var date in cityData) {
        ...
        div.title = '当前时间' + ":" + ' ' + date + ' ' + '空气污染指数' + ':' + ' ' + cityData[date];
        div.style.background = randomColor();//随机获取颜色
        div.style.height = cityData[date] + "px";
